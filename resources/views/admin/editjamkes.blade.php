                ...
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                                <h5 class="card-title text-center">Edit Penerima Jamkesmas</h5>
                                <form action="/postEditjamkes/{{ $jamkes->id }}" method="POST">
                                    @csrf
                                    <div class="form-group mt-4">
                                        <label class="text-secondary mb-2">Kriteria</label>
                                        <input type="text" class="form-control border border-secondary form-control" name="nama" required value="{{ $jamkes -> nama }}">
                                    ...
                                    <div class="form-group mt-1">
                                        <label class="text-secondary mb-2">Menerima Jamkesmas</label>
                                        <input type="number" class="form-control border border-secondary form-control" name="acc" required value="{{ $jamkes -> acc }}">
                                        <span class="text-danger">
                                            @error('acc')
                                              {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="number" class="form-control border border-secondary form-control" name="jmlkp" required value="{{ $jamkes -> jmlkp }}">
                                        <span class="text-danger">
                                            @error('jmlkp')
                                              {{ $message }}
                                            @enderror
