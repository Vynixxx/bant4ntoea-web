                ...
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                                <h5 class="card-title text-center">Edit Agama</h5>
                                <form action="/postEditagama/{{ $agama->id }}" method="POST">
                                    @csrf
                                    <div class="form-group mt-4">
                                        <label class="text-secondary mb-2">Judul agama</label>
                                        <input type="text" class="form-control border border-secondary form-control" name="nama" required value="{{ $agama -> nama }}">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="number" class="form-control border border-secondary form-control" name="lk" required value="{{ $agama -> lk }}">
                                        <span class="text-danger">
                                            @error('lk')
                                              {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="number" class="form-control border border-secondary form-control" name="pr" required value="{{ $agama -> pr }}">
                                        <span class="text-danger">
                                            @error('pr')
                                              {{ $message }}
                                            @enderror
