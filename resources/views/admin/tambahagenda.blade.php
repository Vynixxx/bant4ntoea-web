                        ...
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                              <div href="{{ route('admin.agenda') }}" >
                                <h5 class="card-title text-center">Tambah Agenda</h5>
                                <form action="{{ route('postTambahAgenda') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input class="form-control border border-secondary form-control" name="keterangan" required value="{{ old('keterangan') }}" type="text">
                                        <span class="text-danger">
                                            @error('keterangan')
                                              {{ $message }}
                                            @enderror
