                        ...
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                              <div href="{{ route('admin.agenda') }}" >
                                <h5 class="card-title text-center">Tambah Piramida Penduduk</h5>
                                <form action="{{ route('postTambahpp') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group mt-4">
                                        <label class="text-secondary mb-2">Usia</label>
                                        <input class="form-control border border-secondary form-control" name="usia" required value="{{ old('usia') }}" type="text" placeholder="0-9">
