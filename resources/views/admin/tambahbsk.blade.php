                        ...
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                              <div href="{{ route('admin.agenda') }}" >
                                <h5 class="card-title text-center">Tambah Bantuan Siswa Miskin</h5>
                                <form action="{{ route('postTambahbsk') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="number" class="form-control border border-secondary form-control" name="jml" required value="{{ old('jml') }}">
                                        <span class="text-danger">
                                            @error('jml')
                                            {{ $message }}
                                            @enderror
