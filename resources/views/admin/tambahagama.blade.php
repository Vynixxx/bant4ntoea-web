                        ...
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                              <div href="{{ route('admin.agenda') }}" >
                                <h5 class="card-title text-center">Tambah Agama</h5>
                                <form action="{{ route('postTambahAgama') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group mt-4">
                                        <label class="text-secondary mb-2">Nama Agama</label>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input class="form-control border border-secondary form-control" name="pr" required value="{{ old('pr') }}" type="number">
                                        <span class="text-danger">
                                            @error('pr')
                                              {{ $message }}
                                            @enderror
