        ...
        <div class="container">
            ...
            <div class="row mb-8 page-title py-1" >
              <div class="col-12 d-flex justify-content-center">
                  ...
                  <ol class="breadcrumb bg-transparent px-3 py-2 rounded-3">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Bidang Perikanan</li>
                  </ol>
                  </nav>
              </div>
            </div>
            ...
            <div class="col-lg-10" data-aos="fade" data-aos-delay="100">
                ...
                <div class="list-group-item py-4">
                    ...
                    Terdiri atas tanah-tanah produktif dan non-produktif, serta penggunaannya, lokasi, luas, dan batas desa yang mencerminkan lingkungan geografis setempat.
                    </p>
                </div>
                <div class="list-group-item py-4">
            ...
            <div class="col-lg-8 text-center" data-aos="fade" data-aos-delay="100">
                <h2 class="fw-bold mb-4">Potensi Desa di Bidang Perikanan</h2>
                <p class="text-muted">
                Desa Bantan Tua memiliki potensi yang sangat baik di bidang perikanan. Salah satu potensi yang dapat dikembangkan untuk mendukung ketahanan pangan desa adalah:
                </p>
            </div>
            </div>
            ...
            <div class="col-lg-10" data-aos="fade" data-aos-delay="100">
                ...
                <div class="card-body">
                    ...
                    <li>
                        <h5 class="fw-bold">Pemanfaatan Kolam Warga Bekas Galian Batu Bata</h5>
                        <p class="text-muted mb-0">
                        Kolam bekas galian batu bata milik warga dapat dimanfaatkan untuk budidaya ikan, yang akan mendukung program ketahanan pangan desa dengan menyediakan sumber pangan yang berkelanjutan.
                        </p>
                    </li>
                    </ul>
                </div>
