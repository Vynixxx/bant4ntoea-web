...
<head>
  ...
  <title>Pengurus UED-SP Desa Bantan Tua</title>
  ...
  <main class="main">
            ...
            <div class="col-12 d-flex justify-content-center">
                <nav class="breadcrumbs" data-aos="fade-up">
                  <ol class="breadcrumb bg-transparent px-3 py-2 rounded-3">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Pengurus UED-SP</li>
                  </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container py-5" data-aos="fade">
        ...
        <div class="col-lg-10">
            ...
            <img 
                src="{{ asset('assets/img/uedsp.png') }}" 
                alt="uedsp Desa Bantan Tua" 
